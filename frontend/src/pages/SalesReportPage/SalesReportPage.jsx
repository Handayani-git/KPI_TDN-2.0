...
function SalesReportPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // NOTE: Di dunia nyata, ini idealnya akan MENGUPDATE data yang diinput ADV.
      // Untuk simulasi ini, kita membuat entri baru dengan data penjualan.
      await addDoc(collection(db, "dailyPerformance"), {
        csId: user.id, // ID dari user CS yang login
        advertiserId: null,
